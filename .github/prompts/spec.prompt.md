...
Execute `#requirements` prompt to create detailed requirements specification.

**Present requirements to user for approval before proceeding**

### 3. Stage 2: Design

Execute `#design` prompt to create technical design based on requirements.

**Present design to user for approval before proceeding**

### 4. Stage 3: Task List

Execute `#tasks` prompt to break down design into implementable tasks.
